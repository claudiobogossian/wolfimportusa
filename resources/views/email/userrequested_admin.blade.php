...
<table style="max-width:600px;" border=0>
	<tr>
		...
		COMUNICADO!<br> <br> Recebemos nova solicitação de
			cadastro em nosso site, acessar o sistema ADMINISTRATIVO para
			aprovação.<br> <br>
Novo usuário: <?php echo $fullname." (".$email.")" ?>
<br>
	...
	<tr>
		<td colspan=2 style="font-size: 10px;">(PT) Esta mensagem pode conter
			...
			apague-a. Agradecemos sua cooperação. <br> <br> (EN) This message may
			contain confidential or privileged information and its
			...
			immediately by replying the e-mail and then deleting it. Thank you
